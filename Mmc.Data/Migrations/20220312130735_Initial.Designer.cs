...
namespace Mmc.Data.Migrations
{
    ...
    [Migration("20220312130735_Initial")]
            ...
            modelBuilder.Entity("Mmc.Core.Entity.BlogMaster", b =>
                {
                    ...
                    b.Property<int>("BlogMasterAuthorAdminId")
                        .HasColumnType("INT(11)");

                    b.Property<long>("BlogMasterAuthorAdminUserMasterId")
                    ...
                    b.HasIndex("BlogMasterAuthorAdminUserMasterId");
            ...
            modelBuilder.Entity("Mmc.Core.Entity.BlogMaster", b =>
                {
                    b.HasOne("Mmc.Core.Entity.UserMaster", "BlogMasterAuthorAdmin")
                        .WithMany("Blogs")
                        .HasForeignKey("BlogMasterAuthorAdminUserMasterId")
