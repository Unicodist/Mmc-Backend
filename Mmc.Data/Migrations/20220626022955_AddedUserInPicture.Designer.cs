...
namespace Mmc.Data.Migrations
{
    ...
    [Migration("20220626022955_AddedUserInPicture")]
    partial class AddedUserInPicture
    {
            ...
            modelBuilder.Entity("Mmc.Data.Model.PictureModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Type = "Avatar",
                            UploadedById = 1L,
                            UploadedDate = new DateTime(2022, 6, 26, 8, 14, 55, 225, DateTimeKind.Local).AddTicks(6306)
                        });
                });
            ...
            modelBuilder.Entity("Mmc.Data.Model.User.UserModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Ashish Neupane",
                            Password = "$2a$11$1Z.ydu1YCH8mh0DUWGS33uADexoZf72nPzQOUbxK8SLH6f.WtArwG",
                            PictureId = 1L,
                            UserName = "AshuraNep",
                            UserType = "Superuser"
                        });
