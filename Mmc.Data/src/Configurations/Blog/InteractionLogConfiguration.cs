...
public class InteractionLogConfiguration : IEntityTypeConfiguration<InteractionLogModel>
{
    public void Configure(EntityTypeBuilder<InteractionLogModel> builder)
    {
        ...
        _ = builder.Property(a => a.Action).HasColumnName("action").HasColumnType(ColumnTypes.VARCHAR).HasMaxLength(50).HasConversion(new BaseTypeStringConverter<InteractionAction>());
